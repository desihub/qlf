...
# ======
# XSIGMA
p = Figure(title='SKYPEAK', x_axis_label='RA', y_axis_label='DEC', plot_width=770, plot_height=700           # , x_range=Range1d(left, right), y_range=Range1d(bottom, top)
...
p.circle('x1', 'y1', source=source, name="data", radius=0.0186, hover_fill_color={
