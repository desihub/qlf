    ...
    def load_qa(self):
        ...
        for i, key in enumerate(avobj):
            if objst[key]:
                ...
                fiberlen.append(len(gen_info[key+'_FIBERID']))
        ...
        if objst['ELG']:
            ...
            xfit, yfit = fit_func(
                elg_snr[1], 	snr['FITCOEFF_TGT'][sort_idx[idx]])
            idx += 1
            elg_fit.data['x'] = xfit
        ...
        if objst['LRG']:
            ...
            xfit, yfit = fit_func(
                lrg_snr[1], snr['FITCOEFF_TGT'][sort_idx[idx]])
            idx += 1
            lrg_fit.data['x'] = xfit
        ...
        if objst['QSO']:
            ...
            xfit, yfit = fit_func(
                qso_snr[1], snr['FITCOEFF_TGT'][sort_idx[idx]])
            idx += 1
            qso_fit.data['x'] = xfit
        ...
        if objst['STAR']:
            ...
            xfit, yfit = fit_func(
                star_snr[1], snr['FITCOEFF_TGT'][sort_idx[idx]])
        ...
        elg_plot.circle(x='x', y=y_plot, source=elg, color="blue", size=8, line_color='black',
                        alpha=0.7, hover_color="blue", hover_alpha=1, hover_line_color='red')

        elg_plot.xaxis.axis_label = "DECAM_{}".format(
        ...
        lrg_plot.line(x='x', y=y_plot, source=lrg_fit,
                      color="black", line_width=lw, line_alpha=0.9)
        lrg_plot.circle(x='x', y=y_plot, source=lrg, color="red", size=8, line_color='black',
                        alpha=0.7, hover_color="red", hover_alpha=1, hover_line_color='red')

        lrg_plot.xaxis.axis_label = "DECAM_{}".format(
            str(self.selected_arm).upper())
        ...
        qso_plot.line(x='x', y=y_plot, source=qso_fit,
                      color="black", line_width=lw, line_alpha=0.9)
        qso_plot.circle(x='x', y=y_plot, source=qso, color="green", size=8, line_color='black',
                        alpha=0.7, hover_color="green", hover_alpha=1, hover_line_color='red')

        qso_plot.xaxis.axis_label = "DECAM_{}".format(
            str(self.selected_arm).upper())
        ...
        star_plot.line(x='x', y=y_plot, source=star_fit,
                       color="black", line_width=lw, line_alpha=0.9)
        star_plot.circle(x='x', y=y_plot, source=star, color="orange", size=8, line_color='black',
                         alpha=0.7, hover_color="orange", hover_alpha=1, hover_line_color='red')

        star_plot.xaxis.axis_label = "DECAM_{}".format(
            str(self.selected_arm).upper())
